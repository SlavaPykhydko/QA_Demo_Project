...
from tests.conftest import db_online_orders_counts

def test_sum_done_and_cancel_orders(online_orders_api, db_online_orders_counts):
    ...
    check.equal(db_online_orders_counts["all"],
                db_online_orders_counts["done"] + db_online_orders_counts["cancel"],
